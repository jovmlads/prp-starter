...
Create a new React project in the `app` directory at the root of this repository:
 ...
 * ```
 */
export function ExampleComponent({ data, onSelect }: ExampleComponentProps): ReactElement {
  if (!data) {

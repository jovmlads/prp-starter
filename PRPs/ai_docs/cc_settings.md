...
| `model`                      | Override the default model to use for Claude Code                                                                                                                     | `"claude-4-sonnet-20250101"`                            |
...
| `VERTEX_REGION_CLAUDE_4_HAIKU`             | Override region for Claude 4 Haiku when using Vertex AI                                                                                                            |
| `VERTEX_REGION_CLAUDE_4_SONNET`            | Override region for Claude 4 Sonnet when using Vertex AI                                                                                                           |
